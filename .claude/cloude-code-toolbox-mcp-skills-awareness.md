...
_Generated: 2026-09-09T07:19:01.020Z_
...
Workspace `mcp.json` _(folder: printing_management)_

- **c:\Users\hfcmo\OneDrive\Documents\printo\printing_management\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\hfcmo\.claude.json** — _File exists — no servers defined_
